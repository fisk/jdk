...
private:
  ...
  static volatile int _requested_root;
  ...
  template <bool COOPS, bool allow_gc> static void copy_object(oopDesc* archive_object, void* heap_object_raw_handle, size_t size, markWord mark, Stack<CDSHeapTraversalEntry, mtClassShared>& dfs_stack, JavaThread* thread);
  ...
  static oop materialize_object_transitive(oopDesc* archive_object, Stack<CDSHeapTraversalEntry, mtClassShared>& dfs_stack, JavaThread* thread);
