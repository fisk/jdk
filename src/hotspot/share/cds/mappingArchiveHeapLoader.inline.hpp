...
#ifndef SHARE_CDS_MAPPINGARCHIVEHEAPLOADER_INLINE_HPP
#define SHARE_CDS_MAPPINGARCHIVEHEAPLOADER_INLINE_HPP
...
inline oop MappingArchiveHeapLoader::decode_from_archive_impl(narrowOop v) {
...
inline oop MappingArchiveHeapLoader::decode_from_archive(narrowOop v) {
  return decode_from_archive_impl<false>(v);
}

inline oop MappingArchiveHeapLoader::decode_from_mapped_archive(narrowOop v) {
  return decode_from_archive_impl<true>(v);
}

#endif

#endif // SHARE_CDS_MAPPINGARCHIVEHEAPLOADER_INLINE_HPP
