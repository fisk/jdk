...
static void z_verify_possibly_weak_oop(zpointer* p) {
  ...
  if (!z_is_null_relaxed(o)) {
    ...
    // Verify no missing remset entries
    uintptr_t remset_bits = uintptr_t(o) & ZPointerRememberedMask;
    uintptr_t prev_remembered = ZPointerRemembered ^ ZPointerRememberedMask;
