...
ZObjArrayAllocator::ZObjArrayAllocator(Klass* klass, size_t word_size, int length, bool local, bool do_zero, Thread* thread)
  : ObjArrayAllocator(klass, word_size, length, local, do_zero, thread) {}
