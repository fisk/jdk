...
public:
 ...
 public:
  ...
  void lightweight_lock(Register obj, Register hdr, Register thread, Register tmp, Label& slow, bool check_recursion = true);
  void lightweight_unlock(Register obj, Register hdr, Register tmp, Label& slow, bool check_recursion = true);
};
